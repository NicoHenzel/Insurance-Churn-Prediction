...
<!-- ```{r check-min} -->
<!-- min(df_train_new$feature_3) -->
<!-- min(df_train_new$feature_5) -->
<!-- min(df_train_new$feature_6) -->
<!-- min(df_train_new$feature_11) -->
<!-- min(df_train_new$feature_13) -->
<!-- ``` -->
...
<!-- df_train_new$feature_3 <- -->
<!--  df_train_new$feature_3 + (1 - min(df_train_new$feature_3)) -->

<!-- df_train_new$feature_5 <- -->
<!--  df_train_new$feature_5 + (1 - min(df_train_new$feature_5)) -->

<!-- df_train_new$feature_6 <- -->
<!--  df_train_new$feature_6 + (1 - min(df_train_new$feature_6)) -->
...
churn_rec <-
  ...
  update_role(feature_5,
              feature_6,
              feature_13) %>% 
  # transform the distribution of the features to be more bell-shaped
  # step_log(
  #   feature_3,
  #   feature_5,
  #   feature_6
...
```{r specification}
xgb_spec <-
  # boost_tree atuomatically uses the empirically best parameters if none are specified
  boost_tree() %>%
  # model engine
  set_engine("xgboost") %>%
  # model mode
...
* Was bedeutet ROC
* Wie intepretiere ich die Metriken
