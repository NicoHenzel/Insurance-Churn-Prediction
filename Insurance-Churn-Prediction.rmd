...
The ratio of customers that churn within the training data set is depicted below.
```{r pie-chart}
explore_data %>% 
...
### Correlation of variables to churn
TO DO  
siehe Abschnitt 6:   https://www.kaggle.com/code/blentalikan/insurancechurnprediction 
