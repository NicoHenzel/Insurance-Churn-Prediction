...
The performance of the model itself will be measured by the **F1-Score**. Additionally we will check the ROC curve and the ROC-AUC value to evaluate our hyperparameter tuning. 
...
Thus we can update our recipe and remove `r text_spec("feature_5", color = "red")`.
...
We can see that our model has a high rate of true positives.
The true negative rate on the other hand is not that great.


In order to see the ROC we also plot it
