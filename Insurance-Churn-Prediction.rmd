...
<!-- For the XGBoost algorithm the data needs to be in matrix form. -->
<!-- First we check the given data -->

<!-- ```{r check-matrix} -->
<!-- is.matrix(training_data) -->
<!-- is.matrix(test_data) -->
<!-- ``` -->

<!-- Then we make new dataframes and transform them into matrix form -->
